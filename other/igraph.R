# implementation of heatmap using igraph to
# far slower than using a preprocessed version of the soo data
# keeping this as an example of how to do this in R
